...
class UsersRepository {
  ...
  readByEmail = async (email) => await UsersManager.readByEmail(email);
}

const repository = new UsersRepository();
const { createRepository, readRepository, updateRepository, destroyRepository, readByEmail } = repository;
export { createRepository, readRepository, updateRepository, destroyRepository, readByEmail };
